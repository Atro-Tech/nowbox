<script lang="ts">
	...
	const hosts = [
		...
		{ id: 'modal', icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4.89 5.57 0 14l2.52 4.4h5.05l4.4-7.72 4.51 7.71 5 .04L24 14.06l-4.86-8.45-5.07-.02-2.08 3.6L9.94 5.57Zm.84.73h3.79l1.84 3.25H7.57Zm9.19.02 3.8.01 4.23 7.36-3.74-.03zm-9.82.35L6.94 9.91l-4.21 7.39-1.89-3.3Zm9.19.01 4.3 7.34-1.9 3.28-4.3-7.34zm-6.71 3.6h3.79l-4.21 7.39H3.36Zm11.64 4.11 3.74.03-1.89 3.28-3.74-.03z"/></svg>` },
		...
		{ id: 'aws', icon: `<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M2 8c2 2 6 2 8 0"/><path d="M7 8l3-1"/></svg>` },
		...
		{ id: 'codesandbox', icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M0 24H24V0H0V2.45H21.55V21.55H2.45V0H0Z"/></svg>` },
	...
	const clients = [
		...
		{ id: 'mcp', icon: `<svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 3v8M11 3v8M3 7h8"/></svg>` },
	];
...
<a href="https://github.com/Atro-Tech/nowbox" class="github-link" target="_blank" rel="noopener noreferrer">
